                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="flex flex-col">
                      ...
                      <select
                        ...
                        className="w-full h-[42px] bg-slate-900/60 border border-slate-700 rounded-md pl-3 pr-10 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-cyan-500"
                      >
