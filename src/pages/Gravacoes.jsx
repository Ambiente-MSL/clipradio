...
const GravacoesStats = ({ stats }) => (
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
    <StatCard icon={<Mic className="w-12 h-12 text-primary mb-3" />} value={stats.totalGravacoes} unit="Gravacoes" delay={0.1} />
    ...
    <StatCard icon={<Mic className="w-12 h-12 text-destructive mb-3" />} value={stats.uniqueRadios || stats.uniqueradios || 0} unit="Radios Gravadas" delay={0.4} />
  </div>
);
        ...
        <div>
          ...
          <div className="relative">
            <select id="filterRadio" name="radioId" className="input appearance-none pr-10" value={filters.radioId} onChange={handleFilterChange}>
              <option value="all">Todas as raRadios</option>
              {radios.map((radio) => (
